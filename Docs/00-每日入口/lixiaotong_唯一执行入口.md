...
| **现在** | **Exam04 开套 · 第 1 步** · W3 Lab D1 并行 · [`Lab_Animation_01`](../../Assets/Labs/Stage01_W3/Lab_Animation_01.md) |
...
| **W2 遗留** | Exam03 **P-L1 ✅**（P+1 Build 待补）· **Exam04 第 1 步** · Exam08 断网 · 09/10 可周末补 |
...
**教练输出（v7.16.6 · §11.28 · §11.29 递进 · §11.30 命名 · **K1/R1 门禁**）**
