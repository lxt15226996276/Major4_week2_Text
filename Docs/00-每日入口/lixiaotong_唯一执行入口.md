...
> **你以后只打开这 3 个文件**：  
> ① **本文件**（今天干什么） ② [`../02-学员档案/学员能力档案_lixiaotong.md`](../02-学员档案/学员能力档案_lixiaotong.md) ③ [`../01-成长路线/W3-Lab周-当前.md`](../01-成长路线/W3-Lab周-当前.md)  
> **教练/AI 必读**：本文件 + 档案 + [`../04-教练参考/外部路线吸收库.md`](../04-教练参考/外部路线吸收库.md) **§六** + [`../02-学员档案/踩坑记忆库_lixiaotong.md`](../02-学员档案/踩坑记忆库_lixiaotong.md) · **每次输出前 [`Coach合规四门禁.md`](../../Assets/Exams/Docs/Coach合规四门禁.md) + §11.31 四门禁**
**档案维护（v7.14）**：**开下一套题** 或 **「ExamXX 交付完成」** → AI **同一轮 §11.7 录入**四文件（**不须**学员再催）

---

## 零、你的真实处境（2026-06-25 · W3 起 · AI 维护）

| 项 | 值 |
|----|-----|
| Unity | 2022.3.62f3c1 · 项目 `Major4_week2_Text` |
| 学院 | 元宇宙 · 专业四《Unity开发实战》· **月考纲 U01～U20** |
| SiKi | Unity A计划 · 有效至 **2027-04-15** · 学前必读 **12/20** |
| **现在** | **Exam04 · 第 3 步 Loading** · W3 Lab 并行 · [`Lab_Animation_01`](../../Assets/Labs/Stage01_W3/Lab_Animation_01.md) |
| P / K / S | **84* / 58 / S2-（过渡）** | **K2 动画 = 本周主补** |
| **IC 职级** | **L2 · 合格初级** | 相机 **L2** · 详 [`职级全景_L0-F1`](../01-成长路线/职级全景_L0-F1_Unity客户端_lixiaotong.md) |
| **本周硬交付** | **5 × Lab**（见 [`W3-Lab周-当前`](../01-成长路线/W3-Lab周-当前.md)） |
| **W2 遗留** | Exam03 **P-L1 ✅**（P+1 Build 待补）· **Exam04 第 3 步** · Exam08 断网 · 09/10 可周末补 |
...
**教练输出（v7.16.8 · §11.31 四门禁 · §11.28 十五项 · §11.32 自愈 · **K1/R1/G1/T1**）**

**合规四门禁（每次输出前 · 任一条 ❌ 禁止发 Chat）**：[`Coach合规四门禁.md`](../../Assets/Exams/Docs/Coach合规四门禁.md)  
**A R1** 三遍 Doc · **15 项** · **B G1** UI 步 Glob Prefab · **C K1** 下一步不改库 · **D T1** 触发语→模板 · **E S1** 违规先更全家桶

**Doc 双遍对照（R1 · 门禁 A）**：① 总 `Docs/` + `Assets/Exams/Docs/` 规范与模板 → ② 本套 `ExamXX/Docs/` **当前大步** → ③ **15 项对照全 ✅** 才发 Chat · 讲义/档案脱节 → **§11.32 先更 Doc**
...
### 2026-06-25 · **W3 Lab D1 · Animator 两状态** ← 当前

| 任务 | 说明 |
|------|------|
| 核心 | Idle↔Run · Animator 参数 · Play 切换 |
| 讲义 | [`Lab_Animation_01.md`](../../Assets/Labs/Stage01_W3/Lab_Animation_01.md) |
| 周表 | [`W3-Lab周-当前.md`](../01-成长路线/W3-Lab周-当前.md) |

### 2026-07-06 · **Exam04 · 第 3 步 Loading** ← 当前

| 任务 | 说明 |
|------|------|
| 核心 | **复用 `Exam06/LoadingCanvas.prefab`** · Unpack · **5s 假进度** · `LoadingController` → Main |
| 讲义 | [`Exam04/Docs/分步教程.md`](../../Assets/Exams/Exam04/Docs/分步教程.md) **第 3 步 v7.16.7** |
| 递进 | vs Exam06：**5s 纯假进度** · **StopCoroutine 对称** · 卷面无 BtnMute |
| ⚠️ **O1d** | **禁止** UI→Canvas 手搭 · 须 **3.0 体检 + Unpack** |
| ⚠️ **K1** | Chat「进行下一步」= **只教 · 不改仓库** |

### 2026-07-03 · **Exam04 开套 · 第 1～2 步**（第 2 步 Auth 学员进行中）

| 任务 | 说明 |
|------|------|
| 核心 | 读题 + 三场景 + Build 0→1→2 · Auth 三脚本 |
| 讲义 | [`Exam04/Docs/分步教程.md`](../../Assets/Exams/Exam04/Docs/分步教程.md) |
| 进度 | 第 1 步 ✅ · 第 2 步 Auth **学员自写** |
| **递进** | vs Exam02 Auth · Exam06 Loading · Exam03 战斗 — **每域 +1 档 P-L1** |
...
| 2026-07-05 | **§11.30 工程化命名递进** · Exam04 命名约定 N1 · v7.16.6 |
| 2026-07-06 | **Exam04 第 3 步 O1d-2** · Loading **复用 Exam06/05 LoadingCanvas** · v7.16.7 |
| 2026-07-06 | **§11.31 四层合规门禁** · **§11.32 违规自愈** · [`Coach合规四门禁.md`](../../Assets/Exams/Docs/Coach合规四门禁.md) · v7.16.8 |
